...
const platformSpend = { instagram: 1000, facebook: 400, other: 0, total: 1400 };
...
test('нет расхода — ROAS не определён, а не бесконечность', () => {
  const c = channelSummary_(
    ...
    { instagram: 0, facebook: 0, other: 0, total: 0 }, '2026-07-31'
  );
...
test('пустой период не роняет расчёт', () => {
  const c = channelSummary_([], platformSpend, '2026-07-31');
